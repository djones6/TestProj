...
#### Kubernetes
To deploy your application to your Kubernetes cluster, run `helm install --name myapp .` in the `/chart/TestProj` directory. You need to make sure you change the `repository` variable in your `chart/TestProj/values.yaml` file points to the docker image containing your runnable application.
